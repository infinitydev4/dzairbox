        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/businesses" className="text-sm hover:text-emerald-600 transition-colors">
                  {t("footer.directory")}
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/help" className="text-sm hover:text-emerald-500 transition-colors">
                  {t("footer.helpCenter")}
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <a href="mailto:contact@dzairbox.dz" className="text-sm hover:text-emerald-500 transition-colors">
                  contact@dzairbox.dz
                </a>
              </li>
              <li className="flex items-start space-x-3">
                <Phone className="h-5 w-5 text-emerald-500 flex-shrink-0 mt-0.5" />
                <a href="tel:+213555123456" className="text-sm hover:text-emerald-500 transition-colors">
                  +213 555 123 456
                </a>
              </li>
              <li className="flex items-start space-x-3">
        ...
        <div className="border-t border-gray-200 pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            ...
            <p className="text-sm text-gray-500 text-center sm:text-left">
              © {currentYear} DzairBox. {t("footer.copyright")}
            </p>

            {/* Legal links */}
            <div className="flex flex-wrap justify-center sm:justify-end gap-4 sm:gap-6">
              <Link href="/mentions-legales" className="text-sm text-gray-500 hover:text-emerald-600 transition-colors">
                {t("footer.legalNotice")}
              </Link>
              <Link href="/conditions-generales" className="text-sm text-gray-400 hover:text-emerald-500 transition-colors">
                {t("footer.terms")}
              </Link>
              <Link href="/politique-confidentialite" className="text-sm text-gray-400 hover:text-emerald-500 transition-colors">
                {t("footer.privacy")}
              </Link>
              <Link href="/politique-cookies" className="text-sm text-gray-400 hover:text-emerald-500 transition-colors">
                {t("footer.cookies")}
              </Link>
            </div>
          </div>
